...
let dopBtn = document.querySelector('.inner-program__btn a');
let dopInner = document.querySelector('.program__dop');

more(dopBtn, dopInner, "Смотреть дальше", "Скрыть");

let dopBtn2 = document.querySelector('.author__btn a');
let dopInner2 = document.querySelector('.author__inner-hidden');

more(dopBtn2, dopInner2, "Смотреть далее", "Скрыть");
